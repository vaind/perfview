...
namespace Microsoft.Diagnostics.Tracing.Parsers.ClrPrivate
{
    ...
    [Flags]
    internal enum ModuleRangeIBCType
    {
        None = 0,
    ...
    internal enum BGCAllocWaitReason
    {
        GetLOHSeg = 9,
        AllocDuringSweep = 10,
        AllocDuringBGC = 11,
    }
    internal enum BGCPhase
    {
    ...
    internal enum ModuleRangeSectionType
    {
        ModuleSection = 0x1,
        EETableSection = 0x2,
